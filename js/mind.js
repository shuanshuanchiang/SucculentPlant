...
var ReArray = [
    ...
    },
    {
        ...
        result_say:`你現在的狀況有一點點點疲累，
        需要休息一下或是變換氣氛，在這個快節奏的生活中，每天工作是做不完的，所以當你累的時候，別太強迫自己，
        這也都是每個人成長的過程，有時候放縱自己一下，好好的休息一下，才能有更好的精神去做事，可以出去散散心，旅遊、運動，或是好好的大睡一覺。
        `,
    },
    {
        ...
        需要更小心謹慎，做事情不要太匆匆忙忙，
        很容易漏掉或忘記什麼東西，當你平和下來了，再急迫的事情也能好好的處理，
        面對到的困境也能迎刃而解，
        專注在當前的事情，享受、珍惜現在的所有，
        有時候慢一點，能夠看見以往看不見的世界，人生也會因此變得更有趣。
        `,
    },
